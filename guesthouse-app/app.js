...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const App = {
        ...
        setupRealtimeSubscriptions() {
            ...
            const tables = ['rooms', 'bookings', 'guests', 'invoices', 'booking_add_ons', 'housekeeping_tasks', 'notifications'];
                    ...
                    if (table === 'notifications') {
                        if (payload.eventType === 'INSERT') {
                            ...
                            if (newNotif.target_role === role) {
                                ...
                                const sender = newNotif.sender_name && newNotif.sender_name !== 'System'
                                    ? `${newNotif.sender_name}: `
                                    : '';
                                this.showToast(`${sender}${newNotif.message}`, 'success');
                            }
                        }
                        return;
                    }
